          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
             	  <a href="booking/tambah" class="btn btn-primary">Tambah Booking</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="card collapsed-card">
                        ...
                        <div class="card-body">
                          <i class="fas fa-phone fa-1 mr-1 text-success"></i> <?= $booking['phone'] ?>
                          <br>
                          <i class="fas fa-map-marker-alt fa-1 mr-2 text-danger"></i> <?= $booking['address'] ?>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div class="card collapsed-card">
                        ...
                        <div class="card-body">
                          <i class="fas fa-money-bill-alt fa-1 mr-2 text-success"></i><?= $booking['price'] ?>/hari
                          <br>
                          <i class="fas fa-hashtag fa-1 mr-3 text-warning"></i><?= $booking['total'] ?> tersedia
                        </div>
                      </div>
                    </td>
                    <td><?= $booking['start'] ?></td>
                    ...
                    <td>
                      ...
                      <a href="booking/ubah/<?= $booking['bookings_id'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit fa-1 mr-1"></i>Ubah</a>
                      <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $booking['bookings_id'] ?>" data-name="<?= $booking['name'] ?>"><i class="fas fa-trash fa-1 mr-1"></i>Hapus</button>
                    </td>
                  </tr>
                  <?php endforeach ?>
  ...
  <script>
    $(function(){
      $(".btn-hapus").click(function(){
        ...
        $(".modal-hapus-title").text("Booking oleh " + name);
