                ...
                <table id="tabelMobil" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="mobil/ubah/<?= $car['id'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit fa-1 mr-1"></i>Ubah</a>
                      <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $car['id'] ?>" data-type="<?= $car['type'] ?>"><i class="fas fa-trash fa-1 mr-1"></i>Hapus</button>
                    </td>
                  </tr>
                  <?php endforeach ?>
  ...
  <script>
    $(function(){
      $(".btn-hapus").click(function(){
        ...
        $(".modal-hapus-title").text("Hapus " + type);
